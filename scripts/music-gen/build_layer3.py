...
own voice family.
  ...
  synthwave-el  RETIRED — the pulsed synth-bass arp sat in the same sub-500 Hz
         register as the ambient + melodic stems and was spectrally invisible.
         Replaced by the plucked-saw echo cascade in
         build_synthwave-el_layer3_v2.py (kept out of this script's main()
         so a rerun doesn't clobber raw/synthwave-el-layer3.wav).
...
def main():
    ...
    # synthwave-el layer 3 is built by build_synthwave-el_layer3_v2.py
